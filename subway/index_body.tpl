...
<table cellspacing="1" class="index_body">
	...
	<tr> 
		<td class="row1 one" rowspan="2"><img src="templates/subway/images/whosonline.gif" alt="" /></td>
		<td class="row1 two">{TOTAL_POSTS}<br />
		{TOTAL_USERS}<br />
		{NEWEST_USER}</td>
	</tr>
	<tr> 
		<td class="row1 two">{TOTAL_USERS_ONLINE}<br />
		{RECORD_USERS}<br />
...
<table cellspacing="1" class="index_body_icons">
	<tr> 
		<td><img src="templates/subway/images/folder_new_big.gif" alt=""/>
		{L_NEW_POSTS}&nbsp;&nbsp;
		<img src="templates/subway/images/folder_locked_big.gif" alt="" />
		{L_FORUM_LOCKED}&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
</table>